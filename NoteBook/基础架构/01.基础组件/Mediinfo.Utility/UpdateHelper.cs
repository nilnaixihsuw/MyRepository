...
namespace Mediinfo.Utility
{
    public static class UpdateHelper
    {
       ...
       // public static string FtpRootDirectoryName { get; set; }
        ...
        private static string loginFormName = "Mediinfo.WinForm.HIS.Main";
        /// <summary>
        /// 登录窗口名称
        /// </summary>
        public static string LoginFormName { get { return loginFormName; } set { loginFormName = value; } }
        ...
        public static bool GetFileNoBinary(string ftpFolder, string ftpFileName, string localDir, string localFileName)
        {
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    LogHelper.Default.Error("请检查服务端"+ ftpFolder + "文件夹下是否包含" + ftpFileName + "", ex);
                    return false;
                        ...
                        using (Stream responseStream = response.GetResponseStream())
                        {
                            using (FileStream fs = new FileStream(localfile, FileMode.CreateNew))
                            {
                                ...
                                catch (Exception e)
                                {
                                    ...
                                    LogHelper.Default.Error("请检查服务端" + ftpFolder + "文件夹下是否包含" + ftpFileName + "", e);
                                    return false;
                                }
                            }
                            responseStream.Close();
                ...
                catch (Exception ex)
                {
                    ...
                    LogHelper.Default.Error(localfile + "", ex);
                    return false;
                }
    ...
    public struct UpdateConfigInfo
    {
       ...
       // public string FtpRootDirectoryName;
