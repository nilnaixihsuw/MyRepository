...
namespace Mediinfo.Enterprise.Log
{
    ...
    public class ESLog
    {
        ...
        /// <returns></returns>
        public SysLogEntityList SearchFullFiledss(DateTime startDate, DateTime endDate, Dictionary<string, string> searchDict, int pageIndex, int pageSize, string order = "desc", List<string> contentfilters = null)
        {
            bool isHaoShi = false;
            if (searchDict.Count > 0)
            {
            ...
            {
                contentfilters.ForEach(c =>
                {
                    json.AppendLine(",{\"bool\":{\"should\":{\"match_phrase\": { \"RiZhiNr\":\"" + c + "\"}}}}");
                });
            }
            json.AppendLine("]");
            json.AppendLine("}},");
        ...
        /// <param name="endDate"></param>
        /// <param name="searchDict"></param>
        /// <param name="haoshics"></param>
        /// <param name="pageIndex"></param>
        /// <param name="pageSize"></param>
        /// <param name="order"></param>
        /// <param name="contentfilters"></param>
        /// <returns></returns>
        public SysLogEntityList SearchYiChang(DateTime startDate, DateTime endDate, Dictionary<string, string> searchDict, int haoshics, int pageIndex, int pageSize, string order = "desc", List<string> contentfilters = null)
        {
            if (string.IsNullOrEmpty(address)) return null;
            StringBuilder json = new StringBuilder();
            json.AppendLine("{");
        ...
        /// <param name="contentfilters"></param>
        /// <returns></returns>
        public LogEntityList SearchZdyFullFiledss(string suoyin, DateTime startDate, DateTime endDate, Dictionary<string, string> searchDict, int pageIndex, int pageSize, List<string> contentfilters = null)
        {
            if (string.IsNullOrEmpty(address)) return null;
            StringBuilder json = new StringBuilder();
            json.AppendLine("{");
        ...
        /// <param name="startDate">开始时间</param>
        /// <param name="endDate">结束时间</param>
        /// <param name="searchList">查询文档</param>
        /// <param name="pageIndex">起始页</param>
        /// <param name="pageSize">每页数量</param>
        /// <returns></returns>
        public LogEntityList SearchDBXiaoXi(string suoyin, DateTime startDate, DateTime endDate, List<string> searchList, int pageIndex, int pageSize)
        {
            if (string.IsNullOrEmpty(address)) return null;
            StringBuilder json = new StringBuilder();
            json.AppendLine("{");
            ...
            {
                //需要调用HtmlEntitiesEncode进行转码，否则无法对中文进行查询
                json.AppendLine(",{\"bool\":{\"should\":{\"match_phrase\": { \"RiZhiNr\":\"" + item.HtmlEntitiesEncode() + "\"}}}}");
            }
        ...
        /// <param name="contentfilters"></param>
        /// <returns></returns>
        public LogEntityList SearchDBXiaoXi(string suoyin, DateTime startDate, DateTime endDate, List<string> searchList, int pageIndex, int pageSize, List<string> contentfilters = null)
        {
            if (string.IsNullOrEmpty(address)) return null;
            StringBuilder json = new StringBuilder();
            json.AppendLine("{");
        ...
        /// <param name="contentfilters"></param>
        /// <returns></returns>
        public SysLogEntityList SearchHaoShi(DateTime startDate, DateTime endDate, Dictionary<string, string> searchDict, int pageIndex, int pageSize, string order = "desc", List<string> contentfilters = null)
        {
            if (string.IsNullOrEmpty(address)) return null;
            StringBuilder json = new StringBuilder();
            json.AppendLine("{");
        ...
        /// <returns></returns>
        public LogEntity GetRiZhiById(string suoYin, string id)
        {
            string result = RestClient.HttpRequest("http://" + address + $"/{suoYin}/_doc/{id}", HttpType.GET, "", username, pwd);
            CustHits custHits = JsonUtil.DeserializeToObject<CustHits>(result);
            return custHits?._source;
        }
        ...
        public void ClearAll()
        {
            if (string.IsNullOrEmpty(address))
                return;
            RestClient.HttpRequestNoResult("http://" + address + "/_all", HttpType.DELETE);
        }
    }
}
