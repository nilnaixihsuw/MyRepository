...
namespace Mediinfo.HIS.Core
{
    ...
    public class HISClientHelper
    {
        ...
        /// </summary>
        [Description("英文简称")]
        public static string YINGWENJC { get; set; }
        ...
        /// 患者界面所选中菜单的功能ID
        /// </summary>
        [Description("患者界面所选中菜单的功能ID")]
        public static string SELECTEDGONGNENGID { get; set; }

        /// <summary>
        /// 自定义模糊查询（读取配置文件，请勿人物修改）
        /// 用于MediGridLookUpEdit启用客户端缓存时，控件进行数据过滤根据该字段判断是否使用模糊查询
        /// </summary>
        [Description("自定义模糊查询")]
        ...
        public static Dictionary<string, Control> xiaoXiBackColor = new Dictionary<string, Control>();
        ...
        /// 本地配置文件帮助类（HISClientSetting.xml)
        /// </summary>
        public static HISClientSetting ClientSettingNew { get; set; }
        ...
        /// 第四位 1-是 0-不是
        /// </summary>
        public const string ChuFangLX_HuaLiao = "1001";

        /// <summary>        /// 麻醉药（西药)        /// </summary>        public const string ChuFangLX_MaZui = "1000";

        /// <summary>
        /// GCP处方
        /// </summary>
        public const string ChuFangLX_GCP = "1002";
