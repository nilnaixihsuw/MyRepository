...
namespace Mediinfo.HIS.Core
{
    ...
    public partial class HISGlobalHelper
    {
        static HISGlobalHelper()
        {
            ...
            JcjgHttpConfigs = HISGlobalSetting.LoadJcjgHttpInfo();
        }
        ...
        /// jcjghttp配置文件
        /// </summary>
        public static List<HTTPUpdateConfig> JcjgHttpConfigs { get; set; }
        /// <summary>
        /// 病区类型
        /// </summary>
        ...
        public static class JiuZhenXX_JiLuLY
        {
            ...
            /// 留抢登记
            /// </summary>
            public const string LiuQiang = "8";//留抢登记过来的就珍惜 HR6-2331(547221)
            public static Dictionary<string, string> DataSource { get; set; }
        ...
        /// <summary>
        /// 医嘱分类 1：普通医嘱，2：TPN医嘱，3：化疗医嘱
        /// </summary>
        public static class YiZhuLX
        {
            /// <summary>
            /// 普通医嘱
            /// </summary>
            ...
            /// TPN医嘱
            /// </summary>
            public const int TPN = 2;
            /// <summary>
            /// 化疗医嘱
            /// </summary>
            public const int HuaLiao = 3;
        }
