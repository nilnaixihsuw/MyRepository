...
{
    public partial class ExpressionEditor : MediForm
    {
        /// <summary>
        /// 无参构造函数
        /// </summary>
        ...
        /// 当前控件所在窗体
        /// </summary>
        public Form ControlForm { get; set; }

        /// <summary>
        /// 有参构造函数
        /// </summary>
        /// <param name="control"></param>
        public ExpressionEditor(IExpressionInterface control)
        {
            InitializeComponent();
            ControlForm = ((Control)control).FindForm();
            this.UnboundExpression = control.UnboundExpression;
            this.expressionMemoEdit.Text = UnboundExpression;
            this.listOfInputTypes.SelectedValueChanged += new System.EventHandler(this.listOfInputTypes_SelectedValueChanged);
            this.plusItemButton.Click += new System.EventHandler(this.plusItemButton_Click);
            this.layoutItemButton2.Click += new System.EventHandler(this.layoutItemButton2_Click);
            this.layoutItemButton3.Click += new System.EventHandler(this.layoutItemButton3_Click);
            this.layoutItemButton4.Click += new System.EventHandler(this.layoutItemButton4_Click);

            this.layoutItemButton5.Click += new System.EventHandler(this.layoutItemButton5_Click);
            this.layoutItemButton6.Click += new System.EventHandler(this.layoutItemButton6_Click);
            this.layoutItemButton7.Click += new System.EventHandler(this.layoutItemButton7_Click);
            this.layoutItemButton8.Click += new System.EventHandler(this.layoutItemButton8_Click);
            this.layoutItemButton9.Click += new System.EventHandler(this.layoutItemButton9_Click);
            this.layoutItemButton10.Click += new System.EventHandler(this.layoutItemButton10_Click);
            this.layoutItemButton11.Click += new System.EventHandler(this.layoutItemButton11_Click);
            this.layoutItemButton12.Click += new System.EventHandler(this.layoutItemButton12_Click);
            this.layoutItemButton13.Click += new System.EventHandler(this.layoutItemButton13_Click);
            this.layoutItemButton14.Click += new System.EventHandler(this.layoutItemButton14_Click);
            this.layoutItemButton15.Click += new System.EventHandler(this.layoutItemButton15_Click);
            this.buttonOK.Click += new System.EventHandler(this.buttonOK_Click);
            this.buttonCancel.Click += new System.EventHandler(this.buttonCancel_Click);
            this.listOfInputParameters.SelectedValueChanged += new System.EventHandler(this.listOfInputParameters_SelectedValueChanged);
            this.functionsTypes.EditValueChanged += new System.EventHandler(this.functionsTypes_EditValueChanged);
            this.listOfInputParameters.DoubleClick += new System.EventHandler(this.listOfInputParameters_DoubleClick);
        }
        ...
        {
            this.listOfInputTypes.Items.AddRange(new object[] { ExpressionResource.FunctionsText, ExpressionResource.OperatorsText, ExpressionResource.ConstantsText, ExpressionResource.ParametersText });
