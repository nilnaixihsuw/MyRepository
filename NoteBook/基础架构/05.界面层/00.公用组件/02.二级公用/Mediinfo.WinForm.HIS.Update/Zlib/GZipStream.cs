    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        private int EmitHeader()
        {
            ...
            if (commentBytes != null)
                cbLength = (Comment == null) ? 0 : commentBytes.Length + 1;
            else
                cbLength = 0;

            int fnLength;
            if (filenameBytes != null)
                fnLength = (FileName == null) ? 0 : filenameBytes.Length + 1;
            else
                fnLength = 0;
            ...
            // filename
            if (fnLength != 0 && filenameBytes != null)
            {
            ...
            // comment
            if (cbLength != 0 && commentBytes != null)
            {
