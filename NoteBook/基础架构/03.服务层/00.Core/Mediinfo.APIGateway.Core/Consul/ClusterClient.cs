...
namespace Mediinfo.APIGateway.Core.Consul
{
    ...
    public class ClusterClient : IDisposable
    {
        ...
        //public async Task<string> Deregister(string serviceAddress, int servicePort)
        //{
        ...
        //    {
        //        LogHelper.WriteLog(this.GetType(), "服务被注销了：" + item.Service.ID);
        //        await _consul.Catalog.Deregister(new CatalogDeregistration() { Node = item.Node.Name, ServiceID = item.Service.ID });

        //        //await _consul.Agent.ServiceDeregister(item.Service.ID);
        ...
        public ServiceConfiguration GetConfiguration()
        {
            ...
            //serviceConfiguration.ServicePort = int.Parse(ConfigurationManager.AppSettings["ServicePort"]);
