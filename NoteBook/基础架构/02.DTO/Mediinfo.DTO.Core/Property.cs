    ...
    public class Property
    {
        ...
        public Where Between(object start, object end)
        {
            if (start != null)
            {
                ...
                if (start is DateTime time)
                {
                    return new Where(this, " between ", "TO_DATE('" + time.ToString("yyyy-MM-dd HH:mm:ss") + "', 'yyyy-mm-dd hh24:mi:ss') and TO_DATE('" + time.ToString("yyyy-MM-dd HH:mm:ss") + "', 'yyyy-mm-dd hh24:mi:ss')");
                }
