...
namespace Mediinfo.DTO.Core
{
    ...
    public abstract class DTOBase : INotifyPropertyChanged
    {
      ...
      [JsonProperty]
        ...
        protected void Changing(object oldValue, String propertyName = null)
        {
            ...
            // 记录变化列的原始值
            if (GetTraceChange() && !OriginalValues.ContainsKey(propertyName ?? "") && !string.IsNullOrWhiteSpace(propertyName ?? ""))
        ...
        public void Where(string sql, params object[] parameters)
        {
            ...
            if (parameters != null)
            {
                ...
                parameters.ToList().ForEach(o =>
                {
                    if (PNames.Count > index && !QueryParams.ContainsKey(PNames[index]))
                    {
                        QueryParams.Add(PNames[index], o);
                    }
                    index++;
    ...
    public static partial class DTOExtesion
    {
        ...
        /// <returns></returns>
        public static List<T> GetChanges<T>(this List<T> entitys)
            where T : DTOBase
        {
        ...
        /// <param name="entitys"></param>
        /// <returns></returns>
        public static List<T> GetNews<T>(this List<T> entitys)
            where T : DTOBase
        {
        ...
        /// <param name="entitys"></param>
        /// <returns></returns>
        public static List<T> GetUpdates<T>(this List<T> entitys)
            where T : DTOBase
        {
        ...
        /// <param name="entitys"></param>
        /// <returns></returns>
        public static List<T> GetDeletes<T>(this List<T> entitys)
            where T : DTOBase
        {
